...
class AddController extends FirebasehelperController
{
    ...
    {
        $validator = Validator::make($request->all(), ['name' => 'required|min:1|max:100', 'quotation' => 'required|numeric|min:1|max:5', 'quotation_type' => 'required|numeric|min:0|max:5', 'address' => 'required|min:5|max:1000', 'phone' => 'required|numeric|digits_between:5,40', 'description' => 'required|min:50|max:10000', 'file1' => 'mimes:jpeg,pdf,rar,zip', 'file2' => 'mimes:jpeg,pdf,rar,zip', 'file3' => 'mimes:jpeg,pdf,rar,zip', 'fr' => 'required|min:1|max:10']);
        if ($validator->fails()) {
